...
export const styles: Record<string, CSSProperties> = {
  ...
  hero: { display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'center', padding: 20, border: '1px solid #dbe4ef', borderRadius: 12, background: '#ffffff', boxShadow: '0 1px 2px rgba(15, 23, 42, 0.04)' },
  eyebrow: { margin: 0, color: '#2563eb', fontWeight: 700, fontSize: 13, textTransform: 'uppercase', letterSpacing: 0.08 },
  title: { margin: '6px 0', fontSize: 28, lineHeight: 1.15, color: '#0f172a' },
  subtitle: { margin: 0, color: '#4b5563', maxWidth: 760 },
  tabs: { display: 'flex', gap: 8, flexWrap: 'wrap' },
  tab: { border: '1px solid #cbd5e1', background: '#ffffff', color: '#334155', borderRadius: 999, padding: '8px 12px', cursor: 'pointer' },
  ...
  metricCard: { border: '1px solid #dbe4ef', borderRadius: 12, padding: 14, background: '#ffffff' },
  ...
  card: { padding: 18, border: '1px solid #dbe4ef', borderRadius: 12, background: '#ffffff', boxShadow: '0 1px 2px rgba(15, 23, 42, 0.04)' },
  cardTitle: { margin: '0 0 14px', fontSize: 18 },
  sectionTitle: { margin: '0 0 14px', fontSize: 20 },
  field: { display: 'flex', flexDirection: 'column', gap: 6, marginBottom: 12 },
  label: { fontSize: 13, fontWeight: 700, color: '#374151' },
  input: { width: '100%', border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', font: 'inherit' },
  textarea: { width: '100%', border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', font: 'inherit', resize: 'vertical' },
  inlineGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 },
  inlineInput: { minWidth: 180, border: '1px solid #cbd5e1', borderRadius: 10, padding: '7px 10px', font: 'inherit' },
  ...
  secondaryButton: { border: '1px solid #cbd5e1', background: '#ffffff', color: '#111827', borderRadius: 10, padding: '10px 14px', fontWeight: 700, cursor: 'pointer', marginTop: 8 },
  smallButton: { border: 0, background: '#2563eb', color: '#ffffff', borderRadius: 8, padding: '7px 10px', fontWeight: 700, cursor: 'pointer' },
  secondarySmallButton: { border: '1px solid #cbd5e1', background: '#ffffff', color: '#111827', borderRadius: 8, padding: '7px 10px', fontWeight: 700, cursor: 'pointer' },
  dangerButton: { border: '1px solid #fecaca', background: '#fff1f2', color: '#b91c1c', borderRadius: 8, padding: '7px 10px', fontWeight: 700, cursor: 'pointer' },
