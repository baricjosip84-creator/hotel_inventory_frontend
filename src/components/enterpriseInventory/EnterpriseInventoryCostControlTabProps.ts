...
export function buildEnterpriseInventoryCostControlTabProps(
  ...
  return {
    ...
    carryingCostProductionReview: costData.carryingCostProductionReview,
    carryingCostProductionReviewRows: costData.carryingCostProductionReviewRows,
    carryingCostProductionControls: costData.carryingCostProductionControls,
    carryingCostProductionReviewQuery: queries.carryingCostProductionReviewQuery,
    deadStockProductionReview: costData.deadStockProductionReview,
    deadStockProductionReviewRows: costData.deadStockProductionReviewRows,
    deadStockProductionControls: costData.deadStockProductionControls,
    deadStockProductionReviewQuery: queries.deadStockProductionReviewQuery,
    marginAwareProductionReview: costData.marginAwareProductionReview,
    marginAwareProductionReviewRows: costData.marginAwareProductionReviewRows,
    marginAwareProductionControls: costData.marginAwareProductionControls,
    marginAwareProductionReviewQuery: queries.marginAwareProductionReviewQuery,
    procurementSpendProductionReview: costData.procurementSpendProductionReview,
    procurementSpendProductionReviewRows: costData.procurementSpendProductionReviewRows,
    procurementSpendProductionControls: costData.procurementSpendProductionControls,
