    ...
    <section style={styles.stack}>
      <form onSubmit={onSubmit} style={styles.card}>
        ...
        <div style={styles.formGrid}>
          ...
          <InputField label="Reorder quantity" type="number" value={form.reorder_quantity} onChange={(value) => onFormChange((current) => ({ ...current, reorder_quantity: value }))} required disabled={!canWriteParLevels} />
          <SelectField
