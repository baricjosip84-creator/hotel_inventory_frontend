...
export interface AutomationRunnerStatusResponse {
  ...
  last_tick_output_safety_status?: 'pass' | 'watch' | 'fail' | string | null;
  last_tick_output_anomaly_status?: 'detected' | 'clear' | 'no_tick_evidence' | string | null;
  unsafe_runner_output_detected?: boolean;
  unsafe_runner_output_count?: number | string;
  last_unsafe_runner_output_at?: string | null;
  expected_last_unsafe_runner_output_at?: string | null;
  unsafe_runner_output_review_expected_last_unsafe_runner_output_at?: string | null;
  expected_unsafe_runner_output_count?: number | string | null;
  unsafe_runner_output_review_expected_count?: number | string | null;
  unsafe_runner_output_memory_active?: boolean;
  unsafe_runner_output_memory_status?: 'clear' | 'requires_review' | string;
  unsafe_runner_output_review_required?: boolean;
  unsafe_runner_output_review_acknowledged_at?: string | null;
  unsafe_runner_output_review_acknowledged_by?: string | null;
  unsafe_runner_output_review_acknowledged_unsafe_at?: string | null;
  unsafe_runner_output_review_acknowledged_count?: number | string;
  unsafe_runner_output_review_note?: string | null;
  unsafe_runner_output_review_note_present?: boolean;
  unsafe_runner_output_review_note_length?: number | string;
  unsafe_runner_output_review_note_redacted?: boolean;
  unsafe_runner_output_review_note_min_length?: number | string;
  unsafe_runner_output_review_note_max_length?: number | string;
  unsafe_runner_output_review_acknowledgement_current?: boolean;
  unsafe_runner_output_review_timestamp_current?: boolean;
  unsafe_runner_output_review_count_current?: boolean;
  unsafe_runner_output_review_stale?: boolean;
  unsafe_runner_output_review_recency_status?: 'current' | 'stale' | 'missing' | 'not_required' | string;
  unsafe_runner_output_review_confirmation_required?: boolean;
  unsafe_runner_output_review_acknowledge_allowed?: boolean;
  unsafe_runner_output_review_acknowledge_block_reason?: 'no_anomaly_memory' | 'already_current' | 'missing_latest_unsafe_timestamp' | string | null;
  unsafe_runner_output_review_evidence_complete?: boolean;
  unsafe_runner_output_review_evidence_missing?: string[];
  unsafe_runner_output_review_evidence_status?: 'complete' | 'incomplete' | 'pending_review' | 'not_required' | string;
  unsafe_runner_output_review_acknowledge_result?: string | null;
  unsafe_runner_output_review_rejected_count?: number | string;
  last_unsafe_runner_output_review_rejected_at?: string | null;
  last_unsafe_runner_output_review_rejected_reason?: string | null;
  last_unsafe_runner_output_review_rejected_by?: string | null;
  last_unsafe_runner_output_review_rejected_expected_unsafe_at?: string | null;
  last_unsafe_runner_output_review_rejected_actual_unsafe_at?: string | null;
  last_unsafe_runner_output_review_rejected_expected_count?: number | string | null;
  last_unsafe_runner_output_review_rejected_actual_count?: number | string | null;
  last_unsafe_runner_output_review_rejected_note_present?: boolean;
  last_unsafe_runner_output_review_rejected_note_length?: number | string;
  last_unsafe_runner_output_review_rejected_note_redacted?: boolean;
  unsafe_runner_output_review_rejection_memory_active?: boolean;
  unsafe_runner_output_review_rejection_evidence_complete?: boolean;
  unsafe_runner_output_review_rejection_evidence_missing?: string[];
  unsafe_runner_output_review_rejection_evidence_status?: 'complete' | 'incomplete' | 'not_required' | string;
  reported_executed_request_count?: number | string;
  reported_mutated_inventory?: boolean;
  reported_mutated_products?: boolean;
  reported_mutated_shipments?: boolean;
  last_tick_summary?: {
    outcome?: string | null;
    checked_at?: string | null;
    runner_batch_id?: string | null;
    processed_schedule_count?: number | string;
    created_execution_request_count?: number | string;
    skipped_schedule_count?: number | string;
    failed_schedule_count?: number | string;
    empty_due_batch?: boolean;
    skipped?: boolean;
    skip_reason?: string | null;
    failed?: boolean;
    error_code?: string | null;
    executed_request_count?: number | string;
    mutated_inventory?: boolean;
    mutated_products?: boolean;
    mutated_shipments?: boolean;
    reported_executed_request_count?: number | string;
    reported_mutated_inventory?: boolean;
    reported_mutated_products?: boolean;
    reported_mutated_shipments?: boolean;
    unsafe_runner_output_detected?: boolean;
    safety_status?: 'pass' | 'watch' | 'fail' | string;
  } | null;
  tick_in_flight?: boolean;
  skipped_overlap_count?: number | string;
  successful_tick_count?: number | string;
  failed_tick_count?: number | string;
  observe_only_tick_count?: number | string;
  empty_due_tick_count?: number | string;
  request_creation_tick_count?: number | string;
  last_successful_tick_at?: string | null;
  last_failed_tick_at?: string | null;
  last_empty_due_tick_at?: string | null;
  last_request_creation_tick_at?: string | null;
  last_overlap_skip_at?: string | null;
  last_tick_outcome?: string | null;
  status_generated_at?: string | null;
  last_tick_age_ms?: number | string | null;
  next_tick_in_ms?: number | string | null;
  tick_stale_after_ms?: number | string | null;
  tick_status_fresh?: boolean | null;
  step: number | string;
  ...
  failure_backoff_ms?: number | string;
  race_protection?: {
    enabled: boolean;
    lock_scope: string;
    strategy: string;
...
export interface AutomationRunnerRunOnceResponse {
  processed_schedule_count: number | string;
  empty_due_batch?: boolean;
  created_execution_request_count: number | string;
  executed_request_count: number | string;
  ...
  request_limit_clamped?: boolean;
  runner_batch_id?: string;
  runner_started_at?: string;
  runner_completed_at?: string;
  tenant_scoped?: boolean;
  tenant_id?: string | null;
  manual_runner_run_once?: boolean;
  manual_runner_confirmation_required?: boolean;
  manual_runner_confirmation_received?: boolean;
  triggered_by_user_id?: string | null;
  triggered_by_support_session_id?: string | null;
  triggered_by_platform_user_id?: string | null;
  skipped?: boolean;
  skip_reason?: string;
  race_protection_enabled?: boolean;
  created_execution_requests?: Array<Record<string, unknown>>;
  skipped_schedules?: Array<Record<string, unknown>>;
  checks?: Array<{
    key: string;
    label: string;
    status: 'pass' | 'watch' | 'fail' | string;
...
export interface SystemContextForecastAccuracyGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  minimum_evaluations_per_metric: number;
  minimum_accuracy_score: number;
  minimum_directional_accuracy_rate: number;
  available_snapshots: number;
  generated_from_snapshot_ids?: string[];
  oldest_generated_at?: string | null;
  latest_generated_at?: string | null;
  read_only: boolean;
  accuracy_governance_only: boolean;
  historical_backtest_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  accuracy_governance_summary: null | {
    metric_count: number;
    ready_metric_count: number;
    blocked_metric_count: number;
    blocker_count: number;
    total_evaluation_count: number;
    average_accuracy_score: number;
    average_directional_accuracy_rate: number;
  ...
  metric_accuracy_governance: Array<{
...
export interface SystemContextForecastGovernanceReadiness {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  minimum_required_control_readiness_score: number;
  read_only: boolean;
  governance_readiness_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  governance_readiness_blockers: string[];
  governance_readiness_summary: {
    control_count: number;
    ready_control_count: number;
    blocked_control_count: number;
    blocker_count: number;
    readiness_score: number;
    average_control_readiness_score: number;
    minimum_required_snapshots: number;
    minimum_required_control_readiness_score: number;
  ...
  control_readiness: Array<{
    code: string;
    label: string;
    phase_b_step: string;
    control_status: string;
    control_ready: boolean;
    expected_ready_status: string;
...
export interface SystemContextExecutionIntelligenceLinkage {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  ...
  read_only: boolean;
  execution_intelligence_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  minimum_required_linkage_coverage_rate: number;
  linkage_blockers: string[];
  linkage_summary: {
    total_recommendation_execution_requests: number;
    linked_recommendation_execution_requests: number;
    ready_recommendation_execution_requests: number;
    unlinked_recommendation_execution_requests: number;
    blocked_recommendation_execution_requests: number;
    executed_recommendation_execution_requests: number;
    approved_pending_execution_requests: number;
    linkage_coverage_rate: number;
    minimum_required_linkage_coverage_rate: number;
    readiness_score: number;
    phase_c_step: string;
    read_only: boolean;
  ...
  request_linkage_evidence: Array<{
...
export interface SystemContextExecutionIntelligenceOutcomeScoring {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  previous_capability: string;
  next_capability: string;
  read_only: boolean;
  execution_intelligence_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  minimum_required_execution_outcome_score: number;
  minimum_required_scored_execution_outcome_rate: number;
  outcome_scoring_blockers: string[];
  outcome_scoring_summary: {
    total_recommendation_execution_requests: number;
    scored_recommendation_execution_requests: number;
    ready_recommendation_execution_outcomes: number;
    unscored_recommendation_execution_requests: number;
    failed_recommendation_execution_requests: number;
    blocked_recommendation_execution_outcomes: number;
    average_execution_outcome_score: number;
    scored_execution_outcome_rate: number;
    minimum_required_scored_execution_outcome_rate: number;
    minimum_required_execution_outcome_score: number;
    readiness_score: number;
    phase_c_step: string;
  ...
  request_outcome_scoring_evidence: Array<{
    execution_request_id: string;
    request_type: string;
    status: string;
    execution_status: string | null;
    recommendation_key: string | null;
    execution_outcome_score: number;
    minimum_required_execution_outcome_score: number;
    outcome_classification: string;
    outcome_scored: boolean;
    outcome_ready: boolean;
    result_outcome: string | null;
    has_execution_result: boolean;
    has_audit_evidence: boolean;
...
export interface SystemContextExecutionIntelligenceRollbackEvidence {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  ...
  mutation_enabled: boolean;
  automation_enabled: boolean;
  minimum_required_rollback_evidence_coverage_rate: number;
  rollback_evidence_blockers: string[];
  rollback_evidence_summary: {
    total_recommendation_execution_requests: number;
    rollback_required_execution_requests: number;
    rollback_evidence_present_requests: number;
    rollback_ready_execution_requests: number;
    missing_required_rollback_evidence_requests: number;
    failed_without_rollback_evidence_requests: number;
    blocked_rollback_evidence_requests: number;
    rollback_evidence_coverage_rate: number;
    minimum_required_rollback_evidence_coverage_rate: number;
    readiness_score: number;
    phase_c_step: string;
    read_only: boolean;
  ...
  request_rollback_evidence: Array<{
    execution_request_id: string;
    request_type: string;
    status: string;
    execution_status: string | null;
    ...
    recovery_evidence_present: boolean;
    rollback_posture: string;
...
export interface SystemContextExecutionIntelligenceRiskScoring {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  ...
  mutation_enabled: boolean;
  automation_enabled: boolean;
  maximum_allowed_average_execution_risk_score: number;
  maximum_allowed_high_or_critical_execution_risk_rate: number;
  risk_scoring_blockers: string[];
  risk_scoring_summary: {
    total_recommendation_execution_requests: number;
    risk_scored_recommendation_execution_requests: number;
    risk_ready_recommendation_execution_requests: number;
    blocked_execution_risk_requests: number;
    high_or_critical_execution_risk_requests: number;
    critical_execution_risk_requests: number;
    average_execution_risk_score: number;
    high_or_critical_execution_risk_rate: number;
    maximum_allowed_average_execution_risk_score: number;
    maximum_allowed_high_or_critical_execution_risk_rate: number;
    readiness_score: number;
    phase_c_step: string;
  ...
  request_risk_scoring_evidence: Array<{
    execution_request_id: string;
    request_type: string;
    status: string;
    execution_status: string | null;
...
export interface SystemContextExecutionIntelligenceClosedLoopLearning {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  ...
  mutation_enabled: boolean;
  automation_enabled: boolean;
  minimum_required_closed_loop_completion_rate: number;
  minimum_required_learning_signal_coverage_rate: number;
  closed_loop_learning_blockers: string[];
  closed_loop_learning_summary: {
    total_recommendation_execution_requests: number;
    execution_requests_with_outcomes: number;
    execution_requests_with_learning_signals: number;
    execution_requests_with_learning_signal_evidence: number;
    execution_requests_with_recommended_next_actions: number;
    execution_requests_with_closed_learning_actions: number;
    closed_loop_ready_execution_requests: number;
    blocked_closed_loop_execution_requests: number;
    closed_loop_completion_rate: number;
    learning_signal_coverage_rate: number;
    learning_signal_evidence_coverage_rate: number;
    recommended_next_action_coverage_rate: number;
    closed_learning_action_coverage_rate: number;
    minimum_required_closed_loop_completion_rate: number;
    minimum_required_learning_signal_coverage_rate: number;
    readiness_score: number;
    phase_c_step: string;
  ...
  request_closed_loop_learning_evidence: Array<{
    execution_request_id: string;
    request_type: string;
    status: string;
    execution_status: string | null;
    ...
    learning_signal_evidence_count: number;
    recommended_next_action_count: number;
    closed_learning_action_count: number;
    learning_signals: string[];
    outcome_keys: string[];
    closed_loop_ready: boolean;
    blocker_count: number;
    closed_loop_blockers: string[];
    read_only: boolean;
    phase_c_step: string;
    execution_intelligence_only: boolean;
    execution_enabled: boolean;
...
export interface SystemContextExecutionIntelligenceReadiness {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_readiness_score: number;
  read_only: boolean;
  execution_intelligence_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  execution_intelligence_readiness_blockers: string[];
  execution_intelligence_readiness_summary: {
    capability_count: number;
    ready_capability_count: number;
    blocked_capability_count: number;
    readiness_coverage_rate: number;
    readiness_score: number;
    minimum_required_readiness_score: number;
    blocker_count: number;
    phase_c_step: string;
  ...
  capability_evidence: Array<{
    ...
    status: string;
    readiness_score: number;
    ready_by_status: boolean;
    ready_by_score: boolean;
...
export interface SystemContextAIOperationsHealthMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_health_score: number;
  read_only: boolean;
  ai_operations_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  health_monitoring_blockers: string[];
  health_monitoring_summary: {
    control_count: number;
    healthy_control_count: number;
    degraded_control_count: number;
    unavailable_control_count: number;
    blocker_count: number;
    health_score: number;
    minimum_required_health_score: number;
    pipeline_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  health_controls: Array<{
    ...
    blockers: string[];
    source_status: string;
    source_capability_status: string;
...
export interface SystemContextAIOperationsDegradationMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_degradation_score: number;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  degradation_monitoring_blockers: string[];
  degradation_monitoring_summary: {
    control_count: number;
    healthy_control_count: number;
    watch_control_count: number;
    degraded_control_count: number;
    ...
    minimum_required_degradation_score: number;
    health_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
...
export interface SystemContextAIOperationsPipelineMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  ...
  next_capability: string;
  minimum_required_monitoring_score: number;
  read_only: boolean;
  ai_operations_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  pipeline_monitoring_blockers: string[];
  pipeline_monitoring_summary: {
    control_count: number;
    ready_control_count: number;
    blocked_control_count: number;
    blocker_count: number;
...
export interface SystemContextExecutionIntelligencePhaseClosure {
  status: string;
  method: string;
  phase: string;
  phase_c_step: string;
  ...
  minimum_required_closure_score: number;
  read_only: boolean;
  phase_closure_only: boolean;
  execution_intelligence_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  phase_closure_blockers: string[];
  phase_closure_summary: {
    capability_count: number;
    closed_capability_count: number;
    blocked_capability_count: number;
    blocker_count: number;
  ...
  capability_closure_evidence: Array<{
    code: string;
    label: string;
    phase_c_step: string;
  ...
  implemented_capabilities: Array<{
    code: string;
    label: string;
    phase_c_step: string;
  }>;
...
export interface SystemContextForecastPhaseClosure {
  status: string;
  method: string;
  phase: string;
  phase_b_step: string;
...
export interface SystemContextForecastOutcomeValidationGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  minimum_validation_accuracy_score: number;
  minimum_validation_confidence_score: number;
  max_unvalidatable_scenario_rate: number;
  available_snapshots: number;
  generated_from_snapshot_ids?: string[];
  oldest_generated_at?: string | null;
  latest_generated_at?: string | null;
  read_only: boolean;
  outcome_validation_governance_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  outcome_validation_blockers: string[];
  outcome_validation_summary: null | {
    scenario_count: number;
    ready_scenario_count: number;
    blocked_scenario_count: number;
    critical_or_high_risk_scenario_count: number;
    validation_evidence_count: number;
    blocker_count: number;
    validation_evidence_coverage_rate: number;
    unvalidatable_scenario_rate: number;
    readiness_score: number;
    minimum_required_snapshots: number;
    minimum_validation_accuracy_score: number;
    minimum_validation_confidence_score: number;
  ...
  scenario_outcome_validation_governance: Array<{
    code: string | null;
    metric_code: string | null;
    label: string;
    outcome_validation_status: string;
    outcome_validation_ready: boolean;
    outcome_validation_blockers: string[];
    projected_value: number;
    projected_delta: number;
    preview_direction: string;
    ...
    confidence_score: number;
    historical_accuracy_score: number | null;
    historical_evaluation_count: number;
    ...
    best_model_label: string | null;
    direction_consensus: string;
    validation_evidence_present: boolean;
    read_only: boolean;
    outcome_validation_governance_only: boolean;
    deterministic_engine: boolean;
    forecast_model_enabled: boolean;
...
export interface SystemContextForecastAdjustmentGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  max_adjusted_metric_exposure_rate: number;
  max_high_volatility_adjustment_rate: number;
  minimum_adjustment_explanation_coverage_rate: number;
  available_snapshots: number;
  generated_from_snapshot_ids?: string[];
  oldest_generated_at?: string | null;
  latest_generated_at?: string | null;
  read_only: boolean;
  adjustment_governance_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  adjustment_governance_summary: null | {
    window_count: number;
    ready_window_count: number;
    ...
    ready_metric_count: number;
    blocked_metric_count: number;
    adjusted_metric_count: number;
    high_volatility_adjustment_count: number;
    explained_adjustment_count: number;
    blocker_count: number;
    adjusted_metric_exposure_rate: number;
    high_volatility_adjustment_rate: number;
    adjustment_explanation_coverage_rate: number;
    readiness_score: number;
    minimum_required_snapshots: number;
    max_adjusted_metric_exposure_rate: number;
    max_high_volatility_adjustment_rate: number;
  ...
  window_adjustment_governance: Array<{
    window_code: string | null;
    window_label: string;
    adjustment_governance_status: string;
    adjustment_governance_ready: boolean;
    adjustment_governance_blockers: string[];
    metric_count: number;
    ready_metric_count: number;
    blocked_metric_count: number;
    adjusted_metric_count: number;
    ...
    max_adjusted_metric_exposure_rate: number;
    max_high_volatility_adjustment_rate: number;
    metric_adjustment_governance: Array<{
      metric_code: string | null;
      label: string;
      adjustment_governance_status: string;
      adjustment_governance_ready: boolean;
      adjustment_governance_blockers: string[];
      adjusted_forecast: boolean;
      adjustment_explanation_present: boolean;
      source_weighted_delta: number;
      volatility_adjustment_factor: number;
      volatility_adjusted_delta: number;
      volatility_adjusted_forecast_value: number;
...
export interface SystemContextForecastConfidenceGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  minimum_confidence_score: number;
  strong_confidence_score: number;
  max_low_confidence_exposure_rate: number;
  max_watch_confidence_exposure_rate: number;
  available_snapshots: number;
  generated_from_snapshot_ids?: string[];
  oldest_generated_at?: string | null;
  latest_generated_at?: string | null;
  read_only: boolean;
  confidence_governance_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  confidence_governance_summary: null | {
    window_count: number;
    ready_window_count: number;
    blocked_window_count: number;
    metric_count: number;
    ...
    blocked_metric_count: number;
    low_confidence_metric_count: number;
    watch_confidence_metric_count: number;
    blocker_count: number;
    low_confidence_exposure_rate: number;
    watch_confidence_exposure_rate: number;
    average_confidence_score: number;
    readiness_score: number;
    minimum_required_snapshots: number;
    minimum_confidence_score: number;
  ...
  window_confidence_governance: Array<{
    window_code: string | null;
    window_label: string;
    confidence_governance_status: string;
    confidence_governance_ready: boolean;
    confidence_governance_blockers: string[];
    metric_count: number;
    ready_metric_count: number;
    blocked_metric_count: number;
    low_confidence_metric_count: number;
    ...
    confidence_band: string;
    confidence_band_mix: Record<string, number>;
    metric_confidence_governance: Array<{
      metric_code: string | null;
      label: string;
      confidence_governance_status: string;
      confidence_governance_ready: boolean;
      ...
      confidence_risk_classification: string;
      volatility_classification: string;
      low_confidence_exposure: boolean;
      watch_confidence_exposure: boolean;
      forecast_value: number;
      forecast_delta: number;
      forecast_direction: string;
      historical_point_count: number;
...
export interface SystemContextForecastDegradationGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  minimum_degradation_evaluations_per_metric: number;
  recent_window_size: number;
  max_recent_mean_absolute_percent_error: number;
  max_degradation_delta: number;
  max_recent_error_to_value_ratio: number;
  available_snapshots: number;
  generated_from_snapshot_ids?: string[];
  oldest_generated_at?: string | null;
  latest_generated_at?: string | null;
  read_only: boolean;
  degradation_governance_only: boolean;
  historical_backtest_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  degradation_governance_summary: null | {
    metric_count: number;
    ready_metric_count: number;
    blocked_metric_count: number;
    blocker_count: number;
    degraded_metric_count: number;
    critical_degradation_metric_count: number;
    average_recent_mean_absolute_percent_error: number;
    average_degradation_delta: number;
    readiness_score: number;
    minimum_required_snapshots: number;
    minimum_degradation_evaluations_per_metric: number;
    recent_window_size: number;
  ...
  metric_degradation_governance: Array<{
    metric_code: string | null;
    label: string;
    degradation_governance_status: string;
    degradation_governance_ready: boolean;
    degradation_governance_blockers: string[];
    degradation_severity: string;
    historical_point_count: number;
    evaluation_count: number;
    recent_window_size: number;
    recent_mean_absolute_percent_error: number;
    prior_mean_absolute_percent_error: number;
    degradation_delta: number;
    max_recent_mean_absolute_percent_error: number;
    max_degradation_delta: number;
    recent_mean_absolute_error: number;
    recent_average_actual_value: number;
    recent_error_to_value_ratio: number;
    max_recent_error_to_value_ratio: number;
    accuracy_score: number;
    accuracy_band: string;
    accuracy_risk_classification: string;
...
export interface SystemContextForecastErrorGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  minimum_evaluations_per_metric: number;
  max_mean_absolute_percent_error: number;
  max_critical_mean_absolute_percent_error: number;
  max_error_to_value_ratio: number;
  available_snapshots: number;
  generated_from_snapshot_ids?: string[];
  oldest_generated_at?: string | null;
  latest_generated_at?: string | null;
  read_only: boolean;
  error_governance_only: boolean;
  historical_backtest_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  error_governance_summary: null | {
    metric_count: number;
    ready_metric_count: number;
    blocked_metric_count: number;
    blocker_count: number;
    total_evaluation_count: number;
    average_mean_absolute_percent_error: number;
    average_error_to_value_ratio: number;
    critical_error_metric_count: number;
    high_error_metric_count: number;
    readiness_score: number;
    minimum_required_snapshots: number;
    minimum_evaluations_per_metric: number;
    max_mean_absolute_percent_error: number;
  ...
  metric_error_governance: Array<{
    metric_code: string | null;
    label: string;
    error_governance_status: string;
    error_governance_ready: boolean;
    error_governance_blockers: string[];
...
export interface SystemContextAIOperationsDataQualityMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_data_quality_score: number;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  data_quality_monitoring_blockers: string[];
  data_quality_monitoring_summary: {
    control_count: number;
    complete_control_count: number;
    incomplete_control_count: number;
    poor_control_count: number;
    unusable_control_count: number;
    blocked_control_count: number;
    blocker_count: number;
    data_quality_score: number;
    minimum_required_data_quality_score: number;
    degradation_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  data_quality_controls: Array<{
    code: string;
    label: string;
    phase: string;
    data_quality_status: string;
    data_quality_ready: boolean;
    degradation_severity: string;
    health_status: string;
    monitoring_ready: boolean;
    monitoring_score: number;
...
export interface SystemContextAIOperationsStaleIntelligenceMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_freshness_score: number;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  stale_intelligence_monitoring_blockers: string[];
  stale_intelligence_monitoring_summary: {
    control_count: number;
    fresh_control_count: number;
    freshness_watch_control_count: number;
    stale_blocked_control_count: number;
    stale_unusable_control_count: number;
    stale_control_count: number;
    blocked_control_count: number;
    blocker_count: number;
    freshness_score: number;
    minimum_required_freshness_score: number;
    data_quality_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  stale_intelligence_controls: Array<{
    code: string;
    label: string;
    phase: string;
    freshness_status: string;
    freshness_ready: boolean;
    stale_intelligence_detected: boolean;
    data_quality_status: string;
    data_quality_ready: boolean;
    degradation_severity: string;
    health_status: string;
...
export interface SystemContextAIOperationsNotificationMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_notification_coverage_score: number;
  read_only: boolean;
  ai_operations_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  operational_notification_monitoring_blockers: string[];
  operational_notification_monitoring_summary: {
    control_count: number;
    notification_required_control_count: number;
    notification_ready_required_control_count: number;
    notification_blocked_required_control_count: number;
    critical_notification_control_count: number;
    warning_notification_control_count: number;
    blocker_count: number;
    notification_coverage_score: number;
    minimum_required_notification_coverage_score: number;
    stale_intelligence_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  operational_notification_controls: Array<{
    code: string;
    label: string;
    phase: string;
...
export interface SystemContextAIOperationsSlaMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_sla_score: number;
  minimum_required_notification_coverage_score: number;
  minimum_required_monitoring_score: number;
  read_only: boolean;
  ai_operations_only: boolean;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  ai_operations_sla_monitoring_blockers: string[];
  ai_operations_sla_monitoring_summary: {
    control_count: number;
    sla_ready_control_count: number;
    sla_breached_control_count: number;
    sla_at_risk_control_count: number;
    sla_watch_control_count: number;
    blocker_count: number;
    sla_score: number;
    minimum_required_sla_score: number;
    notification_coverage_score: number;
    minimum_required_notification_coverage_score: number;
    minimum_required_monitoring_score: number;
    notification_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  ai_operations_sla_controls: Array<{
    code: string;
    label: string;
    phase: string;
    sla_ready: boolean;
...
export interface SystemContextAIOperationsAuditEvidenceMonitoring {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  previous_capability: string;
  next_capability: string;
  minimum_required_audit_evidence_score: number;
  read_only: boolean;
  ai_operations_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  ai_audit_evidence_monitoring_blockers: string[];
  ai_audit_evidence_monitoring_summary: {
    control_count: number;
    audit_ready_control_count: number;
    audit_blocked_control_count: number;
    missing_evidence_control_count: number;
    safety_flag_blocked_control_count: number;
    breached_sla_control_count: number;
    blocker_count: number;
    audit_evidence_score: number;
    minimum_required_audit_evidence_score: number;
    sla_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  ai_audit_evidence_controls: Array<{
    code: string;
    label: string;
    phase: string;
    audit_evidence_ready: boolean;
...
export interface SystemContextForecastVersionGovernance {
  status: string;
  method: string;
  phase_b_step: string;
  minimum_required_snapshots: number;
  ...
  latest_generated_at?: string | null;
  read_only: boolean;
  version_governance_only: boolean;
  deterministic_engine: boolean;
  forecast_model_enabled: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  automation_enabled: boolean;
  version_governance_summary: null | {
    version_count: number;
    ready_version_count: number;
    blocked_version_count: number;
    blocker_count: number;
    readiness_score: number;
    phase_b_step: string;
    read_only: boolean;
  ...
  forecast_versions: Array<{
    ...
    status: string;
    method: string;
    forecast_version_key: string;
    forecast_version_fingerprint: string;
    source_status: string;
    metric_count: number;
    watch_count: number;
    ...
    governance_blockers: string[];
    governance_ready: boolean;
    additional_evidence: Record<string, unknown>;
    read_only: boolean;
    version_governance_only: boolean;
    deterministic_engine: boolean;
    forecast_model_enabled: boolean;
...
export interface SystemContextAIOperationsReadinessGate {
  status: string;
  method: string;
  phase: string;
  phase_d_step: string;
  ...
  next_capability: string;
  minimum_required_readiness_score: number;
  required_monitoring_controls: string[];
  read_only: boolean;
  ai_operations_only: boolean;
  execution_enabled: boolean;
  mutation_enabled: boolean;
  ...
  automation_enabled: boolean;
  external_ai_calls_enabled: boolean;
  ai_operations_readiness_gate_blockers: string[];
  ai_operations_readiness_gate_summary: {
    control_count: number;
    required_control_count: number;
    missing_required_control_count: number;
    ready_control_count: number;
    blocked_control_count: number;
    missing_evidence_control_count: number;
    safety_blocked_control_count: number;
    blocker_count: number;
    readiness_score: number;
    minimum_required_readiness_score: number;
    audit_evidence_monitoring_status: string;
    phase_d_step: string;
    next_capability: string;
    read_only: boolean;
    ai_operations_only: boolean;
  ...
  missing_required_controls: string[];
  ai_operations_readiness_controls: Array<{
    code: string;
    label: string;
    phase: string;
