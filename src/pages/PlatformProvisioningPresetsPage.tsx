...
const styles: Record<string, CSSProperties> = {
  ...
  h2: { margin: 0, fontSize: 18, color: '#0f172a', letterSpacing: '-.015em' },
  panel: { border: '1px solid #e2e8f0', borderRadius: 14, padding: 18, background: '#fff', display: 'grid', gap: 16, boxShadow: '0 1px 2px rgba(15,23,42,.03), 0 8px 24px rgba(15,23,42,.04)', minWidth: 0 },
  metaGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(210px,1fr))', gap: 10 },
  muted: { color: '#64748b', fontSize: 13 },
  success: { padding: 12, borderRadius: 10, border: '1px solid #bbf7d0', background: '#f0fdf4', color: '#166534', fontWeight: 700 },
  ...
  inputCompact: { padding: '9px 10px', border: '1px solid #cbd5e1', borderRadius: 10, background: '#fff', color: '#0f172a', font: 'inherit' },
  textarea: { width: '100%', minHeight: 82, boxSizing: 'border-box', padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: 10, background: '#fff', color: '#0f172a', font: 'inherit' },
  ...
  checkboxLabel: { display: 'flex', alignItems: 'center', gap: 7, textTransform: 'capitalize', color: '#334155' },
