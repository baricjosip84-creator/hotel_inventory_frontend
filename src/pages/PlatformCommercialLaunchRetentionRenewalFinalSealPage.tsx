        ...
        <>
          ...
          <section style={styles.card}>
            ...
            <div style={styles.chainGrid}>
              <span>Retention renewal certification: <strong>{humanize(data.retention_renewal_certification_posture)}</strong></span>
              <span>Retention renewal acceptance: <strong>{humanize(data.retention_renewal_acceptance_posture)}</strong></span>
