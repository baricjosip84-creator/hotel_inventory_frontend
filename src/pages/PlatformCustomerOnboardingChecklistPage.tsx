...
export default function PlatformCustomerOnboardingChecklistPage() {
  ...
  const checklist = useQuery({
    queryKey: ['platform', 'customer-onboarding-checklist', tenantId],
  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.panel}>
        ...
        {selectedTenantName ? <span style={styles.help}>Showing onboarding evidence for {selectedTenantName}.</span> : <span style={styles.help}>Showing the latest tenants by creation date.</span>}
      </section>

      {checklist.isLoading ? <section style={styles.card}>Loading onboarding checklist…</section> : null}
      {checklist.error ? <section style={styles.card}>Unable to load onboarding checklist.</section> : null}
