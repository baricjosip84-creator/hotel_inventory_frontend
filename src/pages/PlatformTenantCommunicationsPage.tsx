...
const styles: Record<string, CSSProperties> = {
  ...
  subtitle: { margin: '6px 0 0', color: '#64748b', maxWidth: 860, lineHeight: 1.55 },
  ...
  metrics: { display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 12 },
  metric: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: 14, padding: 16, display: 'grid', gap: 4, boxShadow: '0 1px 2px rgba(15,23,42,.03), 0 8px 24px rgba(15,23,42,.04)' },
  ...
  labelInline: { display: 'inline-flex', gap: 8, alignItems: 'center', fontSize: 13, color: '#334155', fontWeight: 700 },
  input: { border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', fontSize: 14, background: '#fff', color: '#0f172a', minWidth: 0 },
  textarea: { border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', fontSize: 14, minHeight: 105, resize: 'vertical', background: '#fff', color: '#0f172a' },
  ...
  item: { border: '1px solid #e2e8f0', borderRadius: 12, padding: 14, background: '#f8fafc' },
  ...
  badge: { borderRadius: 999, padding: '5px 9px', background: '#fffbeb', color: '#92400e', border: '1px solid #fde68a', fontSize: 12, fontWeight: 700 }
};
