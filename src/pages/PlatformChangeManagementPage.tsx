...
const styles: Record<string, CSSProperties> = {
  ...
  title: { fontSize: 28, lineHeight: 1.15, letterSpacing: '-.025em', fontWeight: 800, color: '#0f172a', margin: 0 },
  muted: { color: '#64748b', fontSize: 13, lineHeight: 1.5, margin: '4px 0' },
  ...
  metaPanel: { display: 'grid', gap: 4, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 12, padding: 14, color: '#475569', fontSize: 13 },
  errorPanel: { display: 'grid', gap: 8, background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 12, padding: 14, color: '#991b1b' },
  ...
  summaryCard: { display: 'grid', gap: 4, padding: 14, border: '1px solid #e2e8f0', borderRadius: 12, background: '#f8fafc', color: '#334155' },
  formHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 12, flexWrap: 'wrap' },
  ...
  card: { border: '1px solid #e2e8f0', borderRadius: 12, padding: 14, background: '#fff', display: 'grid', gap: 12 },
  ...
  badge: { display: 'inline-flex', alignItems: 'center', padding: '4px 9px', borderRadius: 999, fontSize: 12, fontWeight: 700, color: '#334155', border: '1px solid transparent' },
  metaGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 8, color: '#475569', fontSize: 13 },
