...
const styles: Record<string, CSSProperties> = {
  page: { display: 'flex', flexDirection: 'column', gap: '18px', minWidth: 0, color: '#0f172a' },
  ...
  subtitle: { margin: '6px 0 0', color: '#64748b', fontSize: '13px', lineHeight: 1.5 },
  ...
  cardTitle: { margin: '0 0 12px', fontSize: '18px', color: '#0f172a', letterSpacing: '-.015em' },
  metric: { fontSize: '28px', fontWeight: 800, marginTop: '8px', color: '#0f172a' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '12px' },
  field: { display: 'flex', flexDirection: 'column', gap: '6px', fontWeight: 700, color: '#334155', fontSize: '13px' },
  input: { border: '1px solid #cbd5e1', borderRadius: '10px', padding: '10px 12px', background: '#fff', color: '#0f172a', minWidth: 0 },
  textarea: { border: '1px solid #cbd5e1', borderRadius: '10px', padding: '10px 12px', minHeight: '72px', marginTop: '12px', background: '#fff', color: '#0f172a' },
  tableWrap: { overflowX: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse', color: '#334155' },
  th: { textAlign: 'left', borderBottom: '1px solid #e2e8f0', padding: '10px', color: '#64748b', fontSize: '12px' },
  td: { borderBottom: '1px solid #f1f5f9', padding: '10px', verticalAlign: 'top' },
  clickRow: { cursor: 'pointer' },
  badge: { borderRadius: '999px', padding: '4px 9px', fontSize: '12px', fontWeight: 800, background: '#e2e8f0', color: '#475569' },
  badgeGood: { borderRadius: '999px', padding: '4px 9px', fontSize: '12px', fontWeight: 800, background: '#dcfce7', color: '#166534' },
  badgeWarn: { borderRadius: '999px', padding: '4px 9px', fontSize: '12px', fontWeight: 800, background: '#fef3c7', color: '#92400e' },
