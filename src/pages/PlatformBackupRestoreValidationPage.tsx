...
const styles: Record<string, CSSProperties> = {
  page: { padding: '24px', display: 'grid', gap: 18, minWidth: 0 },
  ...
  select: { width: 'min(100%, 420px)', border: '1px solid #d1d5db', borderRadius: 10, padding: '10px 12px' },
  ...
  metricValue: { fontSize: 26, fontWeight: 900, overflowWrap: 'anywhere' },
  ...
  tenantCard: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 16, padding: 18, display: 'grid', gap: 14, boxShadow: '0 1px 2px rgba(0,0,0,0.04)', minWidth: 0 },
  ...
  evidenceItem: { background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 10, padding: 10, display: 'grid', gap: 4, minWidth: 0 },
  ...
  quickLink: { border: '1px solid #cbd5e1', borderRadius: 999, padding: '4px 8px', color: '#0f766e', textDecoration: 'none', fontSize: 12, fontWeight: 700 },
