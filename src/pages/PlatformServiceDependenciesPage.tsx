...
const styles: Record<string, CSSProperties> = {
  ...
  linkCard: { display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center', background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: 12, color: '#334155', fontSize: 13 },
  success: { background: '#f0fdf4', color: '#166534', border: '1px solid #bbf7d0', borderRadius: 12, padding: '10px 12px', fontSize: 13, fontWeight: 700 },
  ...
  input: { border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', font: 'inherit', background: '#fff', color: '#0f172a', minWidth: 0 },
  ...
  dangerButton: { border: '1px solid #dc2626', borderRadius: 9, background: '#dc2626', color: '#fff', padding: '6px 9px', cursor: 'pointer', fontWeight: 700 },
  tableWrap: { overflowX: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse', color: '#334155' },
  rowActions: { display: 'flex', gap: 6, flexWrap: 'wrap' },
  badge: { display: 'inline-block', borderRadius: 999, background: '#dcfce7', color: '#166534', padding: '4px 9px', fontSize: 12, fontWeight: 700 },
  ...
  badgeMuted: { display: 'inline-block', borderRadius: 999, background: '#e2e8f0', color: '#475569', padding: '4px 9px', fontSize: 12, fontWeight: 700 },
  muted: { color: '#64748b', fontSize: 12 },
  error: { color: '#991b1b', fontWeight: 700 },
  errorPanel: { display: 'flex', gap: 12, alignItems: 'center', justifyContent: 'space-between', background: '#fef2f2', color: '#991b1b', border: '1px solid #fecaca', borderRadius: 12, padding: 12, marginBottom: 12, flexWrap: 'wrap' }
};
