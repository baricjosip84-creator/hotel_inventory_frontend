...
const styles: Record<string, CSSProperties> = {
  page: { display: 'flex', flexDirection: 'column', gap: '20px', minWidth: 0, color: '#0f172a' },
  header: { display: 'flex', justifyContent: 'space-between', gap: '16px', alignItems: 'flex-start', flexWrap: 'wrap' },
  title: { margin: 0, fontSize: '28px', lineHeight: 1.15, letterSpacing: '-.025em', color: '#0f172a' },
  subtitle: { color: '#64748b', maxWidth: '820px', lineHeight: 1.5 },
  panel: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '14px', padding: '18px', boxShadow: '0 1px 2px rgba(15,23,42,.03), 0 8px 24px rgba(15,23,42,.04)', minWidth: 0 },
  snapshotGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '10px', marginBottom: '12px' },
  snapshotCard: { display: 'grid', gap: '4px', padding: '12px', border: '1px solid #e2e8f0', borderRadius: '12px', background: '#f8fafc', color: '#334155', fontSize: '13px' },
  supportLinks: { display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' },
  supportLink: { color: 'var(--io-primary-dark)', background: '#fff', border: '1px solid var(--io-primary-border)', borderRadius: 999, padding: '6px 10px', fontWeight: 700, fontSize: '13px', textDecoration: 'none' },
  ...
  th: { textAlign: 'left', padding: '10px 8px', borderBottom: '1px solid #e2e8f0', fontSize: '12px', color: '#64748b', textTransform: 'uppercase', letterSpacing: '.04em', whiteSpace: 'nowrap' },
  td: { padding: '12px 8px', borderBottom: '1px solid #f1f5f9', verticalAlign: 'top' },
  linkButton: { border: 0, background: 'transparent', color: 'var(--io-primary-dark)', cursor: 'pointer', fontWeight: 700, padding: 0 },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '12px' },
  label: { display: 'flex', flexDirection: 'column', gap: '6px', fontWeight: 700, fontSize: '13px', color: '#334155' },
  checkboxLabel: { display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 700, fontSize: '13px', color: '#334155' },
  input: { padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: '10px', background: '#fff', color: '#0f172a' },
  textarea: { padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: '10px', minHeight: '80px', background: '#fff', color: '#0f172a' },
  button: { padding: '10px 14px', border: '1px solid var(--io-primary)', borderRadius: '10px', background: 'var(--io-primary)', color: '#fff', cursor: 'pointer', fontWeight: 700, boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
  disabledButton: { padding: '10px 14px', border: '1px solid #cbd5e1', borderRadius: '10px', background: '#e2e8f0', color: '#64748b', cursor: 'not-allowed', fontWeight: 700 },
  inlineWarning: { gridColumn: '1 / -1', color: '#92400e', background: '#fffbeb', border: '1px solid #fde68a', padding: '10px', borderRadius: '10px', fontSize: '13px' },
  secondaryButton: { padding: '10px 14px', border: '1px solid #cbd5e1', borderRadius: '10px', background: '#fff', color: '#0f172a', cursor: 'pointer', fontWeight: 700 },
  eventBox: { marginTop: '24px', paddingTop: '20px', borderTop: '1px solid #e2e8f0' },
  planSummary: { gridColumn: '1 / -1', display: 'grid', gap: '6px', padding: '12px', border: '1px solid var(--io-primary-border)', borderRadius: '12px', background: 'var(--io-primary-soft)', color: 'var(--io-primary-deep)', fontSize: '13px' },
  ...
  helperText: { color: '#64748b', marginTop: 0, fontSize: '13px' },
  compactList: { margin: 0, paddingLeft: '18px' },
  events: { display: 'grid', gap: '10px' },
  eventItem: { display: 'grid', gridTemplateColumns: '1fr auto auto auto', gap: '12px', padding: '12px', border: '1px solid #e2e8f0', borderRadius: '12px', background: '#fff' },
  error: { color: '#991b1b', background: '#fef2f2', border: '1px solid #fecaca', padding: '10px', borderRadius: '10px', marginTop: '10px' },
