...
const styles: Record<string, CSSProperties> = {
  ...
  supportLink: { color: '#1d4ed8', background: '#fff', border: '1px solid #bfdbfe', borderRadius: 999, padding: '6px 10px', fontWeight: 700, fontSize: '13px', textDecoration: 'none' },
  ...
  linkButton: { border: 0, background: 'transparent', color: '#1d4ed8', cursor: 'pointer', fontWeight: 700, padding: 0 },
  ...
  button: { padding: '10px 14px', border: '1px solid #2563eb', borderRadius: '10px', background: '#2563eb', color: '#fff', cursor: 'pointer', fontWeight: 700, boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
