...
const styles: Record<string, CSSProperties> = {
  ...
  errorCard: { display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center', border: '1px solid #fecaca', borderRadius: 12, padding: '10px 12px', background: '#fef2f2', color: '#991b1b' },
  ...
  input: { border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', minHeight: 38, background: '#fff', color: '#0f172a', minWidth: 0 },
  textarea: { border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', minHeight: 70, resize: 'vertical', background: '#fff', color: '#0f172a' },
  checkRow: { display: 'flex', gap: 8, alignItems: 'center', fontWeight: 700, color: '#334155' },
  ...
  validationMessage: { color: '#991b1b', fontWeight: 700, alignSelf: 'center' },
  secondaryButton: { border: '1px solid #cbd5e1', borderRadius: 9, padding: '8px 10px', background: '#fff', color: '#0f172a', cursor: 'pointer', marginRight: 6, marginTop: 4, fontWeight: 700 },
  ...
  badge: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: 'var(--io-primary-soft-strong)', color: 'var(--io-primary-dark)', fontSize: 12, fontWeight: 700 },
  badgeGood: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#dcfce7', color: '#166534', fontSize: 12, fontWeight: 700 },
  badgeWarn: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#fef3c7', color: '#92400e', fontSize: 12, fontWeight: 700 },
  badgeDanger: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#fee2e2', color: '#991b1b', fontSize: 12, fontWeight: 700 },
  badgeMuted: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#e2e8f0', color: '#475569', fontSize: 12, fontWeight: 700 }
};
