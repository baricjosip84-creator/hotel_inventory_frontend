...
const styles: Record<string, CSSProperties> = {
  ...
  input: { border: '1px solid #d1d5db', borderRadius: 10, padding: '10px 12px', background: '#fff', minWidth: 0 },
  ...
  tenantCard: { border: '1px solid #e5e7eb', borderRadius: 12, padding: 14, background: '#f9fafb', display: 'grid', gap: 12, minWidth: 0 },
  ...
  evidenceItem: { border: '1px solid #e5e7eb', borderRadius: 12, padding: 10, background: '#fff', display: 'grid', gap: 4, minWidth: 0 },
  evidenceLabel: { color: '#6b7280', fontSize: 12, textTransform: 'capitalize', overflowWrap: 'anywhere' },
  controlList: { display: 'grid', gap: 8 },
  controlRow: { display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', borderTop: '1px solid #e5e7eb', paddingTop: 8, flexWrap: 'wrap' },
  ...
  nextInline: { margin: 0, color: '#1e3a8a', overflowWrap: 'anywhere' },
  ...
  notice: { background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 14, padding: 14, color: '#1e3a8a', lineHeight: 1.55, overflowWrap: 'anywhere' },
  empty: { background: '#f9fafb', border: '1px dashed #d1d5db', borderRadius: 12, padding: 14, color: '#6b7280' },
  ...
  error: { background: '#fee2e2', color: '#991b1b', borderRadius: 12, padding: 12, overflowWrap: 'anywhere' },
