  ...
  <div style={styles.list}>
    ...
    {selectedSnapshotQuery.data ? (
      <div style={styles.itemCard}>
        ...
        {selectedSnapshotQuery.data.context_snapshot?.snapshot_capture_policy ? (
          <div style={styles.snapshotSubsection}>
            <div style={styles.itemTitle}>Capture Policy</div>
            <pre style={styles.jsonPreview}>{JSON.stringify(selectedSnapshotQuery.data.context_snapshot.snapshot_capture_policy, null, 2)}</pre>
          </div>
        ) : null}

        {selectedSnapshotQuery.data.context_snapshot?.snapshot_fingerprint ? (
          <KeyValue label="Snapshot Fingerprint" value={String(selectedSnapshotQuery.data.context_snapshot.snapshot_fingerprint)} />
        ) : null}
      </div>
    ) : null}
