...
const styles: Record<string, CSSProperties> = {
  ...
  selectedCard: { borderColor: '#93c5fd', background: '#eff6ff' },
  ...
  button: { width: 'fit-content', padding: '9px 13px', border: '1px solid #2563eb', borderRadius: 9, background: '#2563eb', color: '#fff', cursor: 'pointer', fontWeight: 700, boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
