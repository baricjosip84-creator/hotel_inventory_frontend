...
const styles: Record<string, CSSProperties> = {
  ...
  infoCard: { background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 14, padding: 16, display: 'grid', gap: 6, color: '#1e3a8a' },
  infoText: { lineHeight: 1.55, color: '#1e40af' },
  metaCard: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 14, padding: 18, boxShadow: '0 1px 2px rgba(0,0,0,0.04)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 240px), 1fr))', gap: 12, minWidth: 0 },
  noteDetails: { minWidth: 0 },
  noteSummary: { cursor: 'pointer', fontWeight: 800, color: '#374151' },
  note: { color: '#374151', lineHeight: 1.55, marginTop: 10, overflowWrap: 'anywhere' },
  help: { color: '#6b7280', fontSize: 12, lineHeight: 1.5, overflowWrap: 'anywhere' },
  summaryGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 190px), 1fr))', gap: 12 },
  summaryCard: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 14, padding: 18, boxShadow: '0 1px 2px rgba(0,0,0,0.04)', minWidth: 0 },
  ...
  linkCard: { display: 'block', padding: 10, border: '1px solid #e5e7eb', borderRadius: 10, background: '#f9fafb', color: '#1d4ed8', textDecoration: 'none', fontWeight: 700, lineHeight: 1.4, overflowWrap: 'anywhere' },
  gateList: { display: 'grid', gap: 12 },
  gateCard: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 14, boxShadow: '0 1px 2px rgba(0,0,0,0.04)', minWidth: 0, scrollMarginTop: 16 },
  ...
  gateTitle: { fontSize: 17, color: '#111827', overflowWrap: 'anywhere' },
  gateBody: { borderTop: '1px solid #e5e7eb', padding: 18, display: 'grid', gap: 16, minWidth: 0 },
  countBadge: { display: 'inline-flex', alignItems: 'center', border: '1px solid #d1d5db', background: '#f9fafb', color: '#374151', borderRadius: 999, padding: '5px 9px', fontSize: 12, fontWeight: 800, whiteSpace: 'nowrap' },
  statusText: { fontSize: 12, fontWeight: 800, color: '#4b5563', whiteSpace: 'nowrap' },
  ...
  sectionDescription: { margin: '5px 0 0', color: '#6b7280', lineHeight: 1.5, maxWidth: 900 },
  miniCard: { background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 12, padding: 14, minWidth: 0 },
  list: { margin: 0, paddingLeft: 24, color: '#374151', lineHeight: 1.7, overflowWrap: 'anywhere' },
  controlCard: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 16, padding: 18, display: 'grid', gap: 14, boxShadow: '0 1px 2px rgba(0,0,0,0.04)', minWidth: 0 },
  ...
  surface: { background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 10, padding: 10, color: '#111827', lineHeight: 1.5, overflowWrap: 'anywhere' },
  action: { color: '#374151', lineHeight: 1.5, overflowWrap: 'anywhere' },
  detailsSummaryRow: { cursor: 'pointer', display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'flex-start', flexWrap: 'wrap' },
  summaryHint: { display: 'block', color: '#6b7280', fontSize: 12, fontWeight: 400, lineHeight: 1.45, marginTop: 4 },
