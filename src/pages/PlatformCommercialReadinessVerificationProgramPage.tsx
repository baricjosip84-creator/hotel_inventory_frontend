...
const styles: Record<string, CSSProperties> = {
  ...
  linkCard: { display: 'block', padding: 10, border: '1px solid #e2e8f0', borderRadius: 10, background: '#f8fafc', color: '#1d4ed8', textDecoration: 'none', fontWeight: 700, lineHeight: 1.4, overflowWrap: 'anywhere' },
