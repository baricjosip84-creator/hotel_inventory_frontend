...
const styles: Record<string, CSSProperties> = {
  ...
  panel: { border: '1px solid #e2e8f0', borderRadius: 14, padding: 18, background: '#fff', display: 'grid', gap: 12, boxShadow: '0 1px 2px rgba(15,23,42,.03), 0 8px 24px rgba(15,23,42,.04)', minWidth: 0 },
  ...
  textarea: { border: '1px solid #cbd5e1', borderRadius: 10, padding: '10px 12px', fontSize: 14, minHeight: 72, background: '#fff', color: '#0f172a' },
  inlineChecks: { display: 'flex', gap: 16, flexWrap: 'wrap' },
  metaStrip: { border: '1px solid #e2e8f0', borderRadius: 12, padding: 12, background: '#f8fafc', color: '#475569', display: 'flex', gap: 12, flexWrap: 'wrap', fontSize: 12, fontWeight: 700 },
  linksCard: { border: '1px solid #e2e8f0', borderRadius: 12, padding: 12, background: '#fff', display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center', color: '#334155' },
  ...
  secondaryButton: { border: '1px solid #cbd5e1', borderRadius: 9, background: '#fff', color: '#0f172a', padding: '8px 10px', cursor: 'pointer', marginRight: 6, marginBottom: 6, fontWeight: 700 },
  ...
  errorText: { color: '#991b1b', fontWeight: 700, alignSelf: 'center' },
  tableWrap: { overflowX: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse', minWidth: 980 },
  th: { textAlign: 'left', borderBottom: '1px solid #e2e8f0', padding: 10, fontSize: 13, color: '#475569', background: '#f8fafc' },
  td: { borderBottom: '1px solid #f1f5f9', padding: 10, verticalAlign: 'top', fontSize: 14, color: '#334155' },
  muted: { color: '#64748b', fontSize: 12 },
  warnText: { color: '#92400e', fontSize: 12, fontWeight: 700 },
  dangerText: { color: '#991b1b', fontSize: 12, fontWeight: 700 },
  badge: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: 'var(--io-primary-soft-strong)', color: 'var(--io-primary-dark)', fontSize: 12, textTransform: 'capitalize', fontWeight: 700 },
  badgeWarn: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#fef3c7', color: '#92400e', fontSize: 12, textTransform: 'capitalize', fontWeight: 700 },
  badgeDanger: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#fee2e2', color: '#991b1b', fontSize: 12, textTransform: 'capitalize', fontWeight: 700 },
  badgeGood: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#dcfce7', color: '#166534', fontSize: 12, textTransform: 'capitalize', fontWeight: 700 },
  badgeMuted: { display: 'inline-block', borderRadius: 999, padding: '4px 9px', background: '#e2e8f0', color: '#475569', fontSize: 12, textTransform: 'capitalize', fontWeight: 700 }
};
