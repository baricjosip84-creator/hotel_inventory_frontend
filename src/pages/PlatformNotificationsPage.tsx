...
export default function PlatformNotificationsPage() {
  ...
  return <div style={styles.page}>
    ...
    {canWrite ? <section style={styles.panel}>
      ...
      <button style={styles.button} onClick={() => integrationScan.mutate()} disabled={integrationScan.isPending}>Run integration monitoring scan</button>
    ...
    {canWrite ? <section style={styles.panel}>
      ...
      <div style={styles.routingBox}>
        ...
        <div style={styles.form}>
          ...
          <button style={styles.button} onClick={() => bulkAssignRouting.mutate()} disabled={bulkAssignRouting.isPending || selectedIntegrationNotifications.length === 0}>Assign routing to selected integration notifications ({selectedIntegrationNotifications.length})</button>
        </div>
        ...
        {canWrite && n.source === 'integration_monitoring.scan' && ['open', 'acknowledged'].includes(n.status) ? (
          <div style={styles.routingBox}>
            ...
            <div style={styles.form}>
              ...
              <button style={styles.button} onClick={() => assignRouting.mutate({ id: n.id, values: routingFormFor(n) })} disabled={assignRouting.isPending}>Assign routing</button>
            </div>
          </div>
        ) : null}
