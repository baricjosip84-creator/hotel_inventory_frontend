...
const styles: Record<string, CSSProperties> = {
  ...
  quickLink: { border: '1px solid #cbd5e1', borderRadius: 999, padding: '7px 10px', color: '#1d4ed8', textDecoration: 'none', background: '#fff', fontSize: 13, fontWeight: 700 },
  tableLink: { color: '#1d4ed8', fontSize: 12, textDecoration: 'none', fontWeight: 700 },
  ...
  smallButton: { border: '1px solid #2563eb', borderRadius: 8, padding: '7px 10px', background: '#2563eb', color: '#fff', cursor: 'pointer', fontWeight: 700 },
  ...
  selectedCard: { textAlign: 'left', border: '1px solid #93c5fd', borderRadius: 12, padding: 12, background: '#eff6ff', color: '#1e3a8a', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: 4 },
