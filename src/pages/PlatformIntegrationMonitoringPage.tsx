...
const styles: Record<string, CSSProperties> = {
  ...
  metaStrip: { display: 'flex', flexWrap: 'wrap', gap: 10, padding: '10px 12px', borderRadius: 12, border: '1px solid #bfdbfe', background: '#eff6ff', color: '#1e3a8a', fontSize: 12, fontWeight: 700 },
