...
const styles: Record<string, CSSProperties> = {
  ...
  badge: { display: 'inline-flex', padding: '6px 10px', borderRadius: 999, fontSize: 12, fontWeight: 700, whiteSpace: 'nowrap', border: '1px solid transparent' },
  metaStrip: { display: 'flex', flexWrap: 'wrap', gap: 10, padding: '10px 12px', borderRadius: 12, border: '1px solid var(--io-primary-border)', background: 'var(--io-primary-soft)', color: 'var(--io-primary-deep)', fontSize: 12, fontWeight: 700 },
  linksCard: { display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center', background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: 14, boxShadow: '0 1px 2px rgba(15,23,42,.03)' },
  ...
  success: { color: '#166534', background: '#f0fdf4', border: '1px solid #bbf7d0', padding: '8px 10px', borderRadius: 10, margin: '12px 0 0' },
  error: { color: '#991b1b', background: '#fef2f2', border: '1px solid #fecaca', padding: '8px 10px', borderRadius: 10, margin: '12px 0 0' },
  coverageBox: { marginTop: 12, padding: 12, borderRadius: 12, background: '#f8fafc', border: '1px solid #e2e8f0', color: '#475569' },
  ...
  th: { textAlign: 'left', borderBottom: '1px solid #e2e8f0', padding: '10px 8px', color: '#475569', fontSize: 13, background: '#f8fafc' },
