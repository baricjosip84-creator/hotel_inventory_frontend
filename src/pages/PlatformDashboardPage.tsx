...
const styles: Record<string, CSSProperties> = {
  ...
  title: { margin: 0 },
  muted: { color: '#6b7280', marginBottom: 0 },
  ...
  secondaryButton: { border: '1px solid #cbd5e1', background: '#fff', color: '#0f172a', borderRadius: 10, padding: '10px 14px', fontWeight: 700, cursor: 'pointer' },
  retryButton: { border: '1px solid #fecaca', background: '#fff', color: '#991b1b', borderRadius: 10, padding: '8px 12px', fontWeight: 700, cursor: 'pointer', alignSelf: 'flex-start' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 16 },
  nonStretchGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: 16, alignItems: 'start' },
  card: { background: '#fff', borderRadius: 16, padding: 20, boxShadow: '0 12px 36px rgba(15,23,42,.08)', display: 'flex', flexDirection: 'column', gap: 8, minHeight: 130 },
  ...
  panel: { background: '#fff', borderRadius: 16, padding: 20, boxShadow: '0 12px 36px rgba(15,23,42,.08)', minWidth: 0 },
  ...
  row: { display: 'flex', justifyContent: 'space-between', gap: 16, borderBottom: '1px solid #eee', padding: '10px 0' },
  item: { borderBottom: '1px solid #eee', padding: '12px 0', display: 'flex', flexDirection: 'column', gap: 5, minWidth: 0 },
  ...
  errorPanel: { background: '#fee2e2', color: '#991b1b', borderRadius: 12, padding: 14, display: 'flex', flexDirection: 'column', gap: 8 }
};
