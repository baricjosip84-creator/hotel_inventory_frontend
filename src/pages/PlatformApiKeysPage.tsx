...
const styles: Record<string, CSSProperties> = {
  ...
  scopeGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 8, margin: '12px 0' },
  ...
  primaryButtonDisabled: { border: '1px solid #cbd5e1', borderRadius: 9, padding: '9px 13px', background: '#e2e8f0', color: '#64748b', cursor: 'not-allowed', marginTop: 12, fontWeight: 700, opacity: 1 },
  ...
  linkButton: { border: '1px solid #cbd5e1', borderRadius: 9, padding: '8px 10px', background: '#fff', color: 'var(--io-primary-dark)', cursor: 'pointer', textDecoration: 'none', fontWeight: 700 },
  inlineLink: { color: 'var(--io-primary-dark)', fontWeight: 700, textDecoration: 'none' },
  dangerButton: { border: '1px solid #dc2626', borderRadius: 9, padding: '8px 10px', background: '#dc2626', color: '#fff', cursor: 'pointer', fontWeight: 700 },
  reasonInput: { border: '1px solid #cbd5e1', borderRadius: 9, padding: '8px 10px', minWidth: 140, background: '#fff', color: '#0f172a' },
