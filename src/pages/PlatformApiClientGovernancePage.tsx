...
export default function PlatformApiClientGovernancePage() {
  ...
  return (
    <div style={styles.page}>
      ...
      {governanceQuery.error ? <section style={styles.card}>Unable to load API client governance.</section> : null}
            ...
            <tbody>
              {clients.map((client) => (
                <tr key={client.id}>
                  ...
                  <td style={styles.td}><FlagList flags={client.risk_flags} /></td>
                </tr>
              ))}
