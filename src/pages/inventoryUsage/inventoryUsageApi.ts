...
export async function runDueInventoryUsageTemplates(payload: { dry_run?: boolean; limit?: number; notes?: string } = {}): Promise<InventoryUsageScheduledTemplateRunDueResponse> {
...
export async function consumeInventoryUsageTemplate(
  templateId: string,
  payload: { consumption_reason?: string; department?: string; event_name?: string; notes?: string; consumed_at?: string } = {}
