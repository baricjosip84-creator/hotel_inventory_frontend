...
export type InventoryUsageImpact = {
  ...
  summary?: {
    ...
    estimated_usage_value?: number | string | null;
    recommended_reorder_position_count?: number | string | null;
  };
...
export type InventoryUsageBarcodePreviewResponse = {
  ...
  preview?: {
    ...
    blocked_by_stock_lot_desync?: boolean;
    blocked_by_insufficient_usable_lot_stock?: boolean;
    blocked_by_reserved_stock?: boolean;
    will_deplete?: boolean;
    will_go_below_minimum?: boolean;
    has_sufficient_stock?: boolean;
    has_sufficient_usable_lot_stock?: boolean;
...
export type InventoryUsageTemplateReadinessRow = {
  ...
  projected_usable_lot_quantity_after_use?: number | string | null;
...
export type InventoryUsageTemplateReadiness = {
  ...
  summary?: {
    ...
    stock_lot_desync_count?: number | string | null;
    insufficient_usable_lot_stock_count?: number | string | null;
