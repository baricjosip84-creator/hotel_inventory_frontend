...
const styles: Record<string, CSSProperties> = {
  ...
  metaPill: { display: 'inline-flex', border: '1px solid #bfdbfe', background: '#eff6ff', color: '#1d4ed8', borderRadius: 999, padding: '4px 9px', fontSize: 12, fontWeight: 700 },
  ...
  button: { padding: '9px 13px', border: '1px solid #2563eb', borderRadius: 9, background: '#2563eb', color: '#fff', cursor: 'pointer', fontWeight: 700, boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
  primaryButton: { padding: '9px 13px', border: '1px solid #2563eb', borderRadius: 9, background: '#2563eb', color: '#fff', cursor: 'pointer', fontWeight: 700, boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
