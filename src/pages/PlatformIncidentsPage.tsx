...
const styles: Record<string, CSSProperties> = {
  ...
  header: { display: 'flex', alignItems: 'start', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' },
  ...
  panel: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: 14, padding: 18, display: 'grid', gap: 12, alignSelf: 'start', boxShadow: '0 1px 2px rgba(15,23,42,.03), 0 8px 24px rgba(15,23,42,.04)', minWidth: 0 },
  metadataPanel: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 12, padding: 12, display: 'grid', gap: 6, color: '#475569' },
  linksPanel: { display: 'flex', gap: 10, flexWrap: 'wrap' },
  errorPanel: { background: '#fef2f2', border: '1px solid #fecaca', color: '#991b1b', borderRadius: 12, padding: 12, display: 'grid', gap: 8 },
  ...
  grid: { display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(320px, 420px)', gap: 16, alignItems: 'start' },
  list: { display: 'grid', gap: 12 },
  card: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: 16, cursor: 'pointer', boxShadow: '0 1px 2px rgba(15,23,42,.02)' },
  cardHeader: { display: 'flex', justifyContent: 'space-between', gap: 12 },
  cardTitle: { margin: 0, color: '#0f172a' },
  badges: { display: 'flex', gap: 6, alignItems: 'start', flexWrap: 'wrap' },
  badge: { background: '#dbeafe', color: '#1d4ed8', padding: '4px 9px', borderRadius: 999, height: 'fit-content', fontSize: 12, fontWeight: 700 },
  criticalBadge: { background: '#fee2e2', color: '#991b1b', padding: '4px 9px', borderRadius: 999, height: 'fit-content', fontSize: 12, fontWeight: 700 },
  fieldLabel: { display: 'grid', gap: 6, fontWeight: 700, color: '#334155', fontSize: 13 },
  filterLabel: { display: 'grid', gap: 6, fontWeight: 700, color: '#334155', fontSize: 13 },
  input: { padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: 10, background: '#fff', color: '#0f172a', font: 'inherit' },
  textarea: { padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: 10, minHeight: 80, fontFamily: 'inherit', background: '#fff', color: '#0f172a' },
  ...
  linkButton: { display: 'inline-flex', padding: '8px 12px', border: '1px solid #cbd5e1', borderRadius: 999, background: '#fff', color: '#0f172a', textDecoration: 'none', fontWeight: 700 },
  ...
  disabledDangerButton: { padding: '9px 13px', border: '1px solid #fecaca', borderRadius: 9, background: '#fee2e2', color: '#991b1b', cursor: 'not-allowed', opacity: 0.55, fontWeight: 700 },
  inlineHint: { color: '#92400e', background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 10, padding: 10 },
  ...
  cancelRow: { display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 8 },
  updateBox: { border: '1px solid #e2e8f0', borderRadius: 12, padding: 12, display: 'grid', gap: 10, background: '#fff' },
  detailMeta: { display: 'grid', gap: 4, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, padding: 10, color: '#475569' },
  evidenceLinks: { display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 8 },
  timeline: { display: 'grid', gap: 8 },
  timelineItem: { borderLeft: '3px solid #cbd5e1', paddingLeft: 10, lineHeight: 1.45, color: '#334155' },
