...
const styles: Record<string, CSSProperties> = {
  ...
  inlineLink: { color: '#1d4ed8', fontSize: 13, fontWeight: 700, textDecoration: 'none', alignSelf: 'center' },
  ...
  primaryButton: { background: '#2563eb', color: '#fff', border: '1px solid #2563eb', borderRadius: 9, padding: '9px 13px', cursor: 'pointer', fontWeight: 700, boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
  ...
  badge: { borderRadius: 999, padding: '4px 9px', background: '#dbeafe', color: '#1d4ed8', alignSelf: 'flex-start', fontWeight: 700 },
