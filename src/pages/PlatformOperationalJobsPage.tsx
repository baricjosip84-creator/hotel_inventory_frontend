...
const styles: Record<string, CSSProperties> = {
  ...
  linkCard: { display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 14, padding: '10px 12px', color: '#334155', fontSize: 13 },
  success: { background: '#ecfdf5', border: '1px solid #bbf7d0', color: '#166534', borderRadius: 12, padding: '10px 12px', fontWeight: 700 },
  errorCard: { background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 14, padding: 14, color: '#991b1b', display: 'flex', flexDirection: 'column', gap: 8 },
