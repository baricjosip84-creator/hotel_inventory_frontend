...
const styles: Record<string, CSSProperties> = {
  ...
  input: { border: '1px solid #cbd5e1', borderRadius: 8, padding: '9px 10px', font: 'inherit', minWidth: 0, background: '#fff', color: '#111827' },
  textarea: { border: '1px solid #cbd5e1', borderRadius: 8, padding: '9px 10px', font: 'inherit', minHeight: 76, resize: 'vertical', background: '#fff', color: '#111827' },
  ...
  tableWrapper: { overflowX: 'auto', border: '1px solid #e2e8f0', borderRadius: 10 },
