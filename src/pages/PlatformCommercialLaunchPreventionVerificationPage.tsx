...
const styles: Record<string, CSSProperties> = {
  ...
  openHint: { color: '#1d4ed8', fontSize: 12, fontWeight: 800 },
  linkRow: { display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' },
  linkButton: { display: 'inline-flex', alignItems: 'center', border: '1px solid #cbd5e1', background: '#fff', color: '#1d4ed8', borderRadius: 999, padding: '6px 10px', fontSize: 12, fontWeight: 700, textDecoration: 'none' },
  smallLinkButton: { display: 'inline-flex', alignItems: 'center', border: '1px solid #cbd5e1', background: '#fff', color: '#1d4ed8', borderRadius: 999, padding: '5px 8px', fontSize: 12, fontWeight: 700, textDecoration: 'none', marginTop: 6 },
