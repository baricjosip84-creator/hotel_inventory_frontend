...
const styles: Record<string, CSSProperties> = {
  ...
  supportLink: { border: '1px solid #bfdbfe', background: '#fff', color: '#1d4ed8', borderRadius: 999, padding: '7px 11px', textDecoration: 'none', fontSize: 13, fontWeight: 700 },
  ...
  note: { background: '#eff6ff', border: '1px solid #bfdbfe', color: '#1e3a8a', borderRadius: 10, padding: 12, marginBottom: 12 },
  ...
  evidenceLink: { color: '#1d4ed8', fontSize: 12, display: 'inline-block', marginTop: 4, fontWeight: 700 },
