...
const styles: Record<string, CSSProperties> = {
  ...
  subtitle: { margin: '6px 0 0', color: '#64748b', maxWidth: 900, lineHeight: 1.55 },
  ...
  metaPanel: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 14, padding: 14, display: 'flex', flexWrap: 'wrap', gap: 12, color: '#475569' },
  ...
  button: { padding: '9px 13px', borderRadius: 9, border: '1px solid var(--io-primary)', background: 'var(--io-primary)', color: '#fff', fontWeight: 700, cursor: 'pointer', boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
  dangerButton: { padding: '9px 13px', borderRadius: 9, border: '1px solid #fecaca', background: '#fff', color: '#b91c1c', fontWeight: 700, cursor: 'pointer' },
  linkButton: { background: 'none', border: 0, color: 'var(--io-primary-dark)', cursor: 'pointer', padding: 0, fontWeight: 700 },
  ...
  td: { borderBottom: '1px solid #f1f5f9', padding: '12px 8px', color: '#334155', verticalAlign: 'top' },
  error: { background: '#fef2f2', color: '#991b1b', border: '1px solid #fecaca', borderRadius: 12, padding: 12, marginTop: 12, display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'center' },
  noteBox: { background: 'var(--io-primary-soft)', color: 'var(--io-primary-deep)', border: '1px solid var(--io-primary-border)', borderRadius: 12, padding: 12, marginTop: 12 },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(160px,1fr))', gap: 12, marginTop: 12 },
  card: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 12, padding: 12, display: 'flex', justifyContent: 'space-between', gap: 12 },
  pre: { background: '#0f172a', color: '#e2e8f0', border: '1px solid #1e293b', borderRadius: 12, padding: 14, overflowX: 'auto' },
  entitlements: { marginTop: 20, display: 'flex', flexDirection: 'column', gap: 12 },
  label: { display: 'flex', flexDirection: 'column', gap: 6, fontWeight: 700, color: '#334155' },
  checkboxGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(160px,1fr))', gap: 10 },
  checkboxLabel: { display: 'flex', gap: 8, alignItems: 'center', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, padding: 10, color: '#334155' },
  note: { color: '#64748b', marginTop: 0, lineHeight: 1.55 },
  actionRow: { display: 'flex', flexWrap: 'wrap', gap: 8 },
  adminBox: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 12, padding: 12 },
  sectionTitle: { margin: '0 0 8px', fontSize: 18, letterSpacing: '-.015em', color: '#0f172a' },
  activeBadge: { display: 'inline-block', padding: '4px 9px', borderRadius: 999, background: '#dcfce7', color: '#166534', fontWeight: 700, fontSize: 12 },
  inactiveBadge: { display: 'inline-block', padding: '4px 9px', borderRadius: 999, background: '#f1f5f9', color: '#475569', border: '1px solid #e2e8f0', fontWeight: 700, fontSize: 12 }
};
