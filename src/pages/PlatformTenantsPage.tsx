...
const styles: Record<string, CSSProperties> = {
  ...
  button: { padding: '9px 13px', borderRadius: 9, border: '1px solid #2563eb', background: '#2563eb', color: '#fff', fontWeight: 700, cursor: 'pointer', boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
  ...
  linkButton: { background: 'none', border: 0, color: '#1d4ed8', cursor: 'pointer', padding: 0, fontWeight: 700 },
  ...
  noteBox: { background: '#eff6ff', color: '#1e3a8a', border: '1px solid #bfdbfe', borderRadius: 12, padding: 12, marginTop: 12 },
