...
const styles: Record<string, CSSProperties> = {
  ...
  link: { border: '1px solid #cbd5e1', borderRadius: 999, padding: '6px 10px', background: '#fff', color: '#1d4ed8', textDecoration: 'none', fontSize: 12, fontWeight: 700 },
  inlineLink: { color: '#1d4ed8', fontSize: 12, textDecoration: 'none', fontWeight: 700 },
  ...
  badge: { display: 'inline-block', borderRadius: 999, background: '#dbeafe', color: '#1d4ed8', padding: '4px 9px', fontSize: 12, fontWeight: 700 },
