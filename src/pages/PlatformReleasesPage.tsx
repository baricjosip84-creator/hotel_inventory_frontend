...
export default function PlatformReleasesPage() {
  ...
  const maintenance = useQuery({ queryKey: ['platform', 'release-maintenance'], queryFn: () => platformApiRequest<MaintenanceRegistryResponse>('/platform/maintenance?limit=300&include_past=true'), enabled: canWrite && canReadMaintenance });
