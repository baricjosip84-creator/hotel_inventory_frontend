...
const styles: Record<string, CSSProperties> = {
  ...
  flag: { background: '#dbeafe', color: '#1d4ed8', padding: '4px 9px', borderRadius: 999, fontSize: 12, fontWeight: 700 },
  dangerFlag: { background: '#fee2e2', color: '#991b1b', padding: '4px 9px', borderRadius: 999, fontSize: 12, fontWeight: 700 },
