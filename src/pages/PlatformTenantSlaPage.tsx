...
const styles: Record<string, CSSProperties> = {
  ...
  link: { border: '1px solid #cbd5e1', borderRadius: 999, padding: '7px 10px', color: '#1d4ed8', textDecoration: 'none', fontSize: 13, fontWeight: 700, background: '#fff' },
  ...
  button: { border: '1px solid #2563eb', borderRadius: 9, padding: '9px 13px', background: '#2563eb', color: '#fff', fontWeight: 700, cursor: 'pointer', boxShadow: '0 1px 2px rgba(15,23,42,.05)' },
