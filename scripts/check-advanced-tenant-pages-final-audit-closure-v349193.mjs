...
check(pkg.scripts['check:ci']?.includes('npm run check:advanced-tenant-pages-final-audit-closure-v349193 && npm run check:command-wide-operational-closure-v349194'), 'v3.49.193 remains immediately before v3.49.194 in frontend CI even when newer release guards follow');
