...
check(crossDomain.includes("replenishment_strategy: 'balanced'") && crossDomain.includes("replenishment_strategy: 'transfer_first'") && crossDomain.includes("replenishment_strategy: 'procurement_first'"), 'replenishment source discovery calculates multiple real strategies when the backend can produce them');
