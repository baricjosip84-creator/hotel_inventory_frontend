...
const pageRootTokens = new Map([
  ...
  ['src/pages/TenantAuditPage.tsx', 'tenant-audit-page'],
  ['src/pages/TenantSettingsPage.tsx', 'tenant-settings-page'],
  ['src/pages/AdminSystemPage.tsx', 'admin-system-page'],
  ['src/pages/SessionsPage.tsx', 'sessions-page'],
  ...
  ['src/pages/PurchaseOrdersPage.tsx', 'purchase-orders-page'],
  ['src/pages/ProcurementRecommendationsPage.tsx', 'procurement-recommendations-page']
]);
...
const topOrderStatsMarkers = new Map([
  ...
  ['src/pages/TenantAuditPage.tsx', '<OperationalWorkspaceStats'],
  ['src/pages/TenantSettingsPage.tsx', '<OperationalWorkspaceStats'],
  ['src/pages/AdminSystemPage.tsx', '<OperationalWorkspaceStats'],
  ['src/pages/SessionsPage.tsx', '<OperationalWorkspaceStats'],
  ...
  ['src/pages/PurchaseOrdersPage.tsx', '<OperationalWorkspaceStats'],
  ['src/pages/ProcurementRecommendationsPage.tsx', '<OperationalWorkspaceStats']
]);
