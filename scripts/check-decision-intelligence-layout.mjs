...
const allowedClasses = new Set([
  ...
  'learning-feedback-section', 'learning-feedback-review-board', 'learning-feedback-heading-icon',
  'learning-feedback-detail', 'learning-feedback-detail__grid', 'learning-feedback-detail__evidence',
  'learning-feedback-source-facts', 'learning-feedback-calculated-error', 'learning-feedback-review-authority-note',
  'learning-feedback-history-filters', 'learning-feedback-filter-grid',
  'learning-feedback-view-switch', 'learning-feedback-view-switch__button', 'learning-feedback-source-picker', 'learning-feedback-source-picker--single',
  ...
  'forecast-filters', 'forecast-intro', 'forecast-lifecycle', 'forecast-lifecycle__header', 'forecast-limit-note', 'forecast-pagination', 'forecast-refresh-error', 'forecast-source-focus',
