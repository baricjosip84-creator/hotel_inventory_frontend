...
if (fs.existsSync(frontendPackagePath)) {
  ...
  if (scripts.prebuild !== 'npm run check:unified-ai-contract-suite && npm run check:learning-feedback-locale-runtime-closure-v349192 && npm run check:advanced-tenant-pages-final-audit-closure-v349193 && npm run check:command-wide-operational-closure-v349194 && npm run typecheck:ci') {
  ...
  if (scripts.prelint !== 'npm run check:unified-ai-contract-suite && npm run check:learning-feedback-locale-runtime-closure-v349192 && npm run check:advanced-tenant-pages-final-audit-closure-v349193 && npm run check:command-wide-operational-closure-v349194') {
